    ...
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        <p>
          ...
          a physical process. E-commerce websites have gained immense popularity
          due to their convenience accessibility and the global reach they
          offer.
        </p>
        <p>
          E-commerce websites typically display products or services an detailed
          descriptiond, images, prices and any available variations (e.g. sizes,
